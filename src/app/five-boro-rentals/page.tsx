...
///////////////////////////////////////////////////////////
///// Online Rentals Version with Bike Rental Manager /////
///////////////////////////////////////////////////////////
...
const FiveBoroRentals: React.FC = () => {
  return (
    <>
      <Hero
        headline="5 Boro Bike Tour Rentals"
        image="/images/5boro_6th_ave-web.png"
      />
      <div className="w-full min-h-screen bg-white flex justify-center items-center py-8 px-4">
        <div className="max-w-screen-xl mx-auto">
          ...
          <p className="mb-4">
            <span className="font-bold">Text or call us at 212 414 2453</span> or{" "}
            <span className="font-bold">
              email us at waterfrontbikeshop@gmail.com
            </span>
            (10 road bikes are available for $200 for the weekend) with any
            questions, or as an alternate way to reserve.
          </p>
          <h3 className="text-xl font-semibold mt-4">
            Bicycle Pickup and Return
          </h3>
          <ul className="list-disc pl-6 mb-4">
            ...
            <li>
              * Late returns billed an extra day ($35) unless otherwise arranged
              in advance by calling 212 414 2453.
            </li>
            <li>
              * Late returns to be brought back to the shop at 10 AM the
              following day when the store opens.
            </li>
          </ul>
          <h3 className="text-xl font-semibold mt-4">Deposit Information</h3>
          <p className="mb-4">
            Upon pickup, a Passport or state-issued ID is required as a deposit,
            and a $200 hold will be placed on your credit card.
          </p>
