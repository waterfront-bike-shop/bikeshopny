...
const isAlertActive = () => {
  ...
  const startDate = new Date("2025-05-17T19:00:00"); // May 17, 2025, at 7 PM
      ...
      <div className="w-full min-h-screen bg-white">
        ...
        {showAlert && (
          <div className="bg-red-600 text-white p-4 flex items-center space-x-4">
            ...
            />
            <div>
              <h4 className="font-semibold">Active Now: GFNY Bike Rental Alert</h4>
              <p>Turn off Saturday, May 17 at 7 PM</p>
              <p>Rent a road bike for the May 18 GFNY ride. Pickup the night before (between 6-7 PM) at the shop, return by 6:45 PM next day.</p>
